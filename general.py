...
HELP_SECTIONS = {
    ...
    "📈 Leveling": [
        ...
        "/give_xp, /remove_xp — [admin] manually adjust a member's XP (secret -- ephemeral on slash, DMed to you on the ?prefix version)",
    ...
    "🎈 Fun": [
        ...
        "/rickroll [target] — the classic, no disguise",
    ],
    "😀 Emoji": [
